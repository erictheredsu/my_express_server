sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("namespaceaaa/oDataV4_worklist_demo/app", ".html");
		...
		return Opa5.extend("namespaceaaa.oDataV4_worklist_demo.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["namespaceaaa/oDataV4_worklist_demo/localService/mockserver"], function (mockserver) {
